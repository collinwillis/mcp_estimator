...
async function getActivitiesForProposal({ proposalId }: { proposalId: string; }): Promise<Activity[]> {
...
function calculateProposalTotals(activities: Activity[]): { [key: string]: number } {
