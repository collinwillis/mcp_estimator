              ...
              {users
                ...
                .map((user) => (
                  <TableRow key={user.uid}>
                    ...
                    <TableCell>
                      <Tooltip title="Disable or enable the user's account. When disabled, the user won't be able to log in or access the application.">
                        <Button
                      ...
                      <Tooltip title="Permanently delete the user. This action cannot be undone, and the user's data will be completely removed from the system.">
                        <Button
